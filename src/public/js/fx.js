...
for (const h3 of document.getElementsByTagName("h3")) {
    ...
    dummy.innerHTML = starsSVG;

    const starsElem = dummy.firstElementChild;
    console.log(h3.innerText , h3.clientHeight, h3.getBoundingClientRect());
    starsElem.style.width = starsElem.style.height = h3.clientHeight + "px";

    h3.parentElement.insertBefore(starsElem, h3);
}